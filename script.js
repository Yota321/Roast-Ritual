...
function handleLogin(e) {
    ...
    setTimeout(() => {
        alert(`Welcome back! You have successfully signed in with ${email}\n\nThis is a demo website. No actual authentication was processed.`);
        closeAuthModal();
...
function handleRegister(e) {
    ...
    const confirm = e.target.querySelector('#register-confirm').value;
    ...
    setTimeout(() => {
        alert(`Welcome ${name}! Your account has been created successfully.\n\nThis is a demo website. No actual registration was processed.`);
        closeAuthModal();
